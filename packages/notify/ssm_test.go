...
func TestGetParameters(t *testing.T) {
	testcases := []struct {
		slackTokenKey, channelIDKey, unknownKey string
	}{
		{
			slackTokenKey: "/mature/test/slack-token-key",
			channelIDKey:  "/mature/test/channel-id-key",
	...
	for _, tc := range testcases {
		...
		_, err := ssm.GetParameters(ctx, tc.slackTokenKey, tc.channelIDKey, tc.unknownKey)
		if err != nil {
